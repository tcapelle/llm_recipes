...
def _generate(prompt, model, tokenizer, gen_config):
    ...
    with torch.inference_mode():
        ...
        return dict(generation=generation, generation_ids=generation_ids, total_time=total_time, num_gen_tokens=num_gen_tokens)
...
if __name__=="__main__":
    ...
    print(df.head())
    df.to_csv(f"{config.model_at}_results.csv")
